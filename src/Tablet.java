...
public class Tablet {
    ...
    public Tablet (String item, String manufacturer, String model, double displaySize, String archiveSpace, double buyingPrice, double sellingPrice) {
        this.id = generateID();
        this.item = item;
    ...
    // Method to generate a unique ID for the tablet
